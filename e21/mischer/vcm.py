...
import e21.core
from e21.mischer.core import Mischer
...
class FieldScan(Vcm, e21.core.Plottable):
...
class TemperatureScan(Vcm, e21.core.Plottable):
...
class AngleScan(Vcm, e21.core.Plottable):
...
def check_empty_files(filelist, mode = 'vcm'):
    """ 
        ...
        for n, file in enumerate(filelist):
			...
			try:
				...
				if Test.data['datetime'][0]:
					...
					self._measurements[index].params['General_Informations']['filename'] = file
